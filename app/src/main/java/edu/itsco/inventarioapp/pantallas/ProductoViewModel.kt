...
class ProductoViewModel (application: Application): ViewModel(){
    ...
    init {
        val myDB = InventarioDB.companion.getInstance(application.applicationContext)
...
class ProductoViewModelFactory(val application: Application): ViewModelProvider.Factory {
